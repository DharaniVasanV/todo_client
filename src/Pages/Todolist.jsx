...
const Todolist = () => {
  ...
  const postTodo=async()=>{
    try{
       await axios.post('https://todo-server-ec2-k78z.onrender.com/csbs/addtodo', {todo}).then(
  ...
  const getTodo=async()=>{
    try{
      await axios.get('https://todo-server-ec2-k78z.onrender.com/csbs/gettodo').then(
  ...
  const deleteTodo=async(id)=>{
    try{
      await axios.delete(`https://todo-server-ec2-k78z.onrender.com/csbs/deletetodo/${id}`).then(
        (response)=>{console.log(response)}
      )
      getTodo()
    }
  ...
  const updateTodo=async(id)=>{
    try{
      await axios.put(`https://todo-server-ec2-k78z.onrender.com/csbs/updatetodo/${id}`,{todo:editText})
      setEditId(null)
      setEditText('')
      getTodo()
    }
